                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $userfb->name }}" required autofocus>
                        ...
                        <div class="row{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <input id="email" placeholder="exmple@mail.com" type="email" class="form-control" name="email" value="{{ userfb->email }}" required>
